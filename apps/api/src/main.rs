...
use database::{establish_connection, AuthRepository, SettingsRepository, DashboardRepository, ReportRepository, SecurityRepository, DiscoveryRepository};
...
async fn main() -> anyhow::Result<()> {
    ...
    let discovery_repo = Arc::new(DiscoveryRepository::new(Arc::new(db_connection.clone())));
